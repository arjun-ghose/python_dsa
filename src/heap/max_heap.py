...
logger = Logger('MaxHeapLogger').get_logger()
...
class MaxHeap:
    ...
    def _sink_down(self, index: int) -> None:
        ...
        while True:
            ...
            if right_index < len(self.heap) and self.heap[right_index] > self.heap[right_index]:
    ...
    def remove(self) -> int | None:
        ...
        if len(self.heap) == 1:
            ...
            logger.info(f'Removed value - {max_value}')
            return max_value
